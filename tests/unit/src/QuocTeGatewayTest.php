...
//        $this->assertEquals('https://mtf.onepay.vn/vpcpay/vpcpay.op?' . http_build_query($this->options, '', '&'), $response->getRedirectUrl());
        ...
        $response = $this->gateway->createResponse('\Nilead\OmniOnePay\Message\QuocTePurchaseResponse', array('vpc_TxnResponseCode' => 0), 'purchase');
    ...
    public function testPurchaseFailure()
    {
        ...
        $response = $this->gateway->createResponse('\Nilead\OmniOnePay\Message\QuocTePurchaseResponse', array('vpc_Message' => 'Field AgainLink value is invalid.'), 'purchase');
